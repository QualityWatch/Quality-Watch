...
type: 'column',
data: [30.2,26.9,24.8,25.1,25.8,27.4]
,index: 4
},
{
name: 'Transferred - (in/not in custody)',
type: 'column',
data: [17.1,16.2,15.5,15.1,15.1,14.9]
,index: 3
},
{
name: 'Other',
type: 'column',
data: [4.1,3,2.9,2.5,2.7,2.8]
,index: 2
},
{
name: 'Treatment declined ',
type: 'column',
data: [3.8,3.6,3.1,2.9,2.7,2.2]
,index: 1
},
{
name: 'Treatment withdrawn',
type: 'column',
data: [1.8,1.4,1.1,1,0.8,0.8]
,index: 0
},
{
name: 'Treatment completed free of dependence',
type: 'line',
data: [43.0042,48.8701,52.6311,53.2931,52.9109,51.9015]
,index: 5
}
]
}
