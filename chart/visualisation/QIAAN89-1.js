    /* Created by ianb on 20/03/2015 10:36:00 using v2.5 */ {
        ...
        exporting: {
            chartOptions: {
                title: {
                    text: 'How has life expectancy changed by country?'
                },
                credits: {
                    enabled: true,
        ...
        yAxis: {
            title: {
                text: 'Life expectancy from birth (years)'
            },
            min: 60,
            labels: {}
        },
        legend: {
            title: {
                text: 'Click on series name to show or hide'
            },
            borderWidth: 2
        },
        series: [{
            ...
            type: 'line',
            data: [
                76.5,76.7,77.0,76.8,77.1,77.3,77.1,77.8,77.7,77.9,78.2,78.2,78.9,79.0,79.2,79.4,79.5,79.6,79.7,79.9,79.9,80.3,80.6,80.7,81.0,81.1,81.3,81.5,81.6,81.9,81.8],
            index: 15
        }, {
            name: 'United Kingdom',
            visible: true,
            type: 'line',
            data: [74.1,74.3,74.5,74.7,74.8,75.2,75.3,75.4,75.7,75.9,76.3,76.2,76.8,76.7,76.9,77.2,77.3,77.5,77.9,78.2,78.3,78.4,79.0,79.2,79.5,79.7,79.8,80.4,80.6,81.0,81.0],
            index: 16
        }, {
            name: 'USA',
            visible: false,
            type: 'line',
            data: [74.5,74.6,74.7,74.7,74.7,74.9,74.9,75.1,75.3,75.5,75.7,75.5,75.7,75.7,76.1,76.5,76.7,76.7,76.7,76.8,76.9,77.1,77.4,77.4,77.7,77.9,78.1,78.5,78.6,78.7],
            index: 17
        }
        ]
    }
