/* Created by rreed on 20/02/2017 12:58:31 using v2.7 */{
title: {text:''},
...
series:[
{
name: 'Patients not treated within 28 days of cancellation as percentage of cancellations',
type: 'line',
data: [13.7,12,11.3,13.9,8.6,9.9,11.5,12.8,10,11.1,12.4,17.3,12.8,12.9,15.2,16.1,17.6,13,16.9,18.3,19.4,18.2,19.3,23.9,21.9,18.4,22.1,21.8,23.4,22.4,24,23.6,16.5,13,12,7.5,10.9,9,8.5,9.6,9.8,9.5,12.5,13.5,12.5,8.9,7.9,7.7,7.3,5.2,5.2,5,4.9,4.9,4.6,6.1,4.6,3.2,4.2,5.5,3.9,2.5,3.3,4.5,3,2.7,3.1,5.5,4.6,3.2,3.8,6.3,5.3,4.4,4.1,5.6,7,3.8,4.3,4.7,5.1,4.3,6.3,8.7,7.2,5.9,5.9,8,8.4,6.3,7.3]
,index: 1
},
{
type: 'line',
marker: {fillColor: 'none', lineColor: null },
name: 'Patients not treated within 28 days of cancellation as percentage of cancellations trendline',
data: [[0, 17.1],[90, 3.3]]
}
]
}
