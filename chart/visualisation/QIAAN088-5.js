/* Created by EFisher on 01/10/2015 16:03:41 using v2.7 */{
        title: {
            text: ''
        },
        credits: {
        ...
        series: [{
            ...
            type: 'column',
            data: [12, 11, 9, 11, 11, 10, 10, 12, 5, 12, 2, 9, 11, 7, 11, 11, 12, 10, 11, 9, 2, 8, 6, 4, 8, 10, 9, 5, 6, 6, 6, 3, 5, 8, 5, 7, 7, 4, 4, 1, 4, 5, 2, 2, 1, 2, 3, 4, 4, 6, 3, 3],
            index: 1
        }, {
            name: 'breaching the 8 minute target for responding to category A calls',
            type: 'column',
            data: [0, 1, 3, 1, 1, 2, 2, 0, 7, 0, 10, 3, 1, 5, 1, 1, 0, 2, 1, 3, 10, 4, 5, 7, 3, 1, 2, 6, 5, 5, 5, 8, 6, 3, 6, 4, 4, 7, 7, 10, 7, 6, 9, 9, 10, 9, 8, 7, 7, 5, 8, 8],
            index: 2
        }, {
            name: 'National breach',
            type: 'line',
            data: [null, null, null, null, null, null, null, null, 13, null, 13, null, null, 13, null, null, null, null, null, null, 13, null, null, 13, null, null, null, 13, null, 13, 13, 13, 13, null, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13],
            index: 1
        }]
    }