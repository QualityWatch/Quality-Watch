...
type: 'line',
data: [6.3,6.2,5.4,5.5,5.9,6.2,5.8,5.9,6.4,6.2,5.8,5.8,6.5,6.7,5.6,5.6,5.9,6.0,6.0,6.0,6.5,6.5,6.2,6.1,6.7,6.8,5.9,6.4,6.6,6.4,6.5,6.6,7.0,6.9,6.5,6.5,7.2,7.2,6.2,6.2,6.8,7.1]
,index: 1
},
{
name: 'Admitted (unadjusted) RTT pathways',
type: 'line',
data: [8.4,9.6,9.7,8.8,8.7,9.3,9.5,9.0,9.1,9.7,9.5,9.3,8.5,9.9,10.2,9.2,9.1,9.4,9.5,9.2,9.2,9.8,9.7,9.4,8.8,10.2,10.2,9.3,9.6,10.0,9.8,9.7,9.7,10.5,10.3,10.1,9.3,10.6,10.9,10.1,9.7,10.1]
,index: 2
},
{
name: 'Non-Admitted RTT pathways',
type: 'line',
data: [4.9,5.8,4.7,4.8,5.0,5.5,5.4,5.2,5.5,6.0,5.4,5.4,5.1,6.1,5.2,5.0,5.5,5.5,5.6,5.4,5.6,6.1,5.7,5.7,5.3,6.3,5.4,5.3,5.9,5.8,5.9,5.9,5.9,6.5,6.2,6.0,5.6,6.7,5.8,5.6,5.6,6.1]
,index: 3
}
]
}
