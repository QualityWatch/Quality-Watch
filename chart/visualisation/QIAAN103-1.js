/* Created by NCODowd on 28/06/2016 14:29:54 using v2.7 *//* Created by EFisher on 04/04/2016 16:09:23 using v2.7 */
/* Created by NCODowd on 04/04/2016 14:15:52 using v2.7 */
{
        ...
        series: [{
            ...
            type: 'line',
            yAxis: 0,
            data: [0.87, 1.39, 1.59, 1.67, 3.06, 2.98, 1.96, 1.93, 1.8, 1.71, 1.71, 1.33, 1.22, 1.82, 2.1, 2.11, 2.48, 3.24, 3.73, 2.24, 2.39, 1.96, 1.97, 1.63, 1.68, 2.14, 2.48, 2.66, 3.66, 4.52, 4.69, 5.4, 5.48, 2.21, 1.98, 2.1, 2.45, 3.13, 3.09, 2.7, 3.27, 4.16, 4.59, 3.24, 3.53, 3.83, 3.27, 3.59, 3.56, 4.4, 5.33, 5.53, 9.53, 9.83, 7.85, 6.49, 6.23, 5.03, 4.16, 3.65, 4.4, 5.59, 6.6, 7.19, 6.76, 10.67, 10.86, 10.93, 8.44] 
        }, {
            name: 'Number',
            type: 'column',
            yAxis: 1,
            data: [1, 0, 0, 2, 15, 17.29, 2.71, 0.57, 6.43, 2.57, 9.57, 5.86, 1, 9.29, 41.57, 28.14, 4, 8, 6, 1, 0, 0, 1.86, 1.14, 2, 2, 0, 1, 13.71, 49.57, 17.29, 81.43, 43, 0, 7, 3, 2, 9, 20.71, 7.29, 20.86, 42.14, 76.86, 9.71, 23.43, 10, 8.29, 5.43, 8.29, 28.14, 54.86, 35, 186.43, 650.14, 183.86, 53.57, 58, 46, 25, 22, 28, 23, 58, 28, 29, 158, 188, 350, 203]
        }]
    }