/* Created by ianb on 08/06/2015 16:39:55 using v2.6 */{
title: {text:''},
...
type: 'line',
data: [26.6,24.7,23.4,22.8,22.4,21.7,21.4,21.3,20.3,21.2,21.8,22.5,22.7,22.6,22.7,23,23.1,21.7,21,20.8]
,index: 1
},
{
name: 'Adults aged under 65 with a physical disability or sensory impairment',
type: 'line',
data: [10.6,14.4,15.1,18.2,19.9,22.7,23.2,22.2,21.1,21.2,21.1,21.4,21.7,20.6,19.7,19.8,20.7,19.5,18.6,18.7]
,index: 2
},
{
name: 'Adults aged under 65 with learning disabilities',
type: 'line',
data: [1.5,2.6,3.3,4.4,5.1,5.4,6.3,6.7,6.2,7.4,8.2,9.9,11.2,11.9,12.7,12.7,13.8,13.1,12.8,12.8]
,index: 3
},
{
name: 'Adults aged under 65 with mental health needs',
type: 'line',
data: [3.7,4.8,5.5,5.5,4.9,5.6,5.3,5.8,5.1,5.4,5.2,5.6,5.7,5.6,5.9,5.8,7.3,7.6,7,6.6]
,index: 4
}
]
}
