/* Created by JMorris on 14/03/2018 12:31:13 using v2.7 */{
title: {text:''},
...
type: 'line',
data: [1.1,1,1.3,1.4,1.1,1.1,1.2,1.6,1.1,0.9,1,1.2,0.9,0.8,0.9,0.9,0.8,0.8,1,1,0.9,0.8,1,1.2,0.8,0.8,0.9,1.1,0.8,0.7,1,0.9,0.7,0.7,0.8,0.9,0.8,0.7,0.9,1.1,0.8,0.8,0.9,0.9,0.8,0.8,1,1.1,0.8,0.8,0.9,1.2,0.9,1,1.1,1.1,1,0.9,1.1]},
{ tooltip: {
            valueSuffix: '%'},
name: 'Patients not operated on within 28 days of cancellation as % of cancellations',
type: 'line',
yAxis: 1,
data: [10.9,9,8.5,9.6,9.8,9.5,12.5,13.5,12.5,8.9,7.9,7.7,7.3,5.2,5.2,5,4.9,4.9,4.6,6.1,4.6,3.2,4.2,5.5,3.9,2.5,3.3,4.5,3,2.7,3.1,5.5,4.6,3.2,3.8,6.3,5.3,4.4,4.1,5.6,7,3.8,4.3,4.7,5.1,4.3,6.3,8.7,7.2,5.9,5.9,8,8.4,6.3,7.3,7.8,7.2,6.8,7.3]}]
}